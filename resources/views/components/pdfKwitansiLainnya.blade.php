<div class="pdf-wrapper">
    ...
    <table class="tabels">
        ...
        <tbody class="tabels-body">
            <tr class="tabels-r">
                <td class="tabels-d" style="text-align: left;font-size: 0.85em;padding: 4px;">{{$lain->kode_jenis_penerimaan}}</td>
                <td class="tabels-d" style="text-align: left;font-size: 0.85em;padding: 4px;">{{$lain->nama_jenis_penerimaan}}</td>
                <td class="tabels-d" style="text-align: right;font-size: 0.85em;padding: 4px;">Rp {{number_format($lain->nominal, 0);}}</td>
            </tr>
        </tbody>
    </table>
