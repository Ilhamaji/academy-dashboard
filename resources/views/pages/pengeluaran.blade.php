...
@section('dashboard-content')
    ...
    <div class="flex mb-2">
        <p class="text-sm text-blue-500">Pengeluaran</p>
        <div class="mx-1">/</div>
    </div>
    ...
    <div class="flex">
        ...
        <span class="inline my-auto ml-2 font-bold">Tambah Data Pengeluaran</span>
    </div>

    <div class="flex">
        @include('components.modalTambahJenisPengeluaran')
    </div>
                ...
                @foreach ($jenis_pengeluaran as $jenis)
                    <tr class="odd:bg-white even:bg-gray-100">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium flex justify-self-end">
                            <a href="/pengeluaran/edit/{{$jenis->kode}}" class="cursor-pointer bg-blue-500 hover:bg-blue-700 p-3 rounded-lg">
