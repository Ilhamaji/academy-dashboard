                        ...
                        @foreach ($pengeluarans as $pengeluaran)
                            <tr class="odd:bg-white even:bg-gray-100">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium flex justify-self-end">
                                    <a href="/transaksi/pengeluaran/edit/{{$pengeluaran->id}}" class="cursor-pointer bg-blue-500 hover:bg-blue-700 p-3 rounded-lg">
                                    ...
                                    <a onclick="return confirm('Apakah anda yakin untuk menghapus {{ $pengeluaran->id }}?')" href="/transaksi/pengeluaran/hapus/{{$pengeluaran->id}}" class="cursor-pointer bg-red-500 hover:bg-red-700 p-3 rounded-lg group ml-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
