...
@section('dashboard-content')
    ...
    <div class="md:grid md:grid-flow-col mt-6 gap-4">
        <div class="w-auto h-fit bg-white shadow-md rounded-lg p-10">
        ...
        <div class="overflow-auto w-full shadow-md rounded-lg col-span-6">
            <table class="table-auto border-collapse w-full">
              <thead>
                <tr class="rounded-lg text-xs md:text-sm font-bold text-gray-500 bg-slate-200 text-left">
                  <th class="p-4 text-center"><p>NISN</p></th>
                  <th class="p-4"><p>Nama</p></th>
                  <th class="p-4 text-center"><p>Aksi</p></th>
                </tr>
              </thead>
              <tbody class="text-xs md:text-sm font-normal text-gray-700 bg-white">
                @foreach ($kelass as $kelas)
                    <tr class="hover:bg-gray-100 border-gray-200 border-b">
                        <td class="p-4 font-bold text-center"><p>{{ $kelas->nama_kelas }}</td>
                        <td class="p-4"><p>{{ $kelas->wali_kelas }}</td>
                        <td class="p-4 flex">
