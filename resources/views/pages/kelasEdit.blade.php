...
@section('dashboard-content')
    ...
    <div class="md:grid md:grid-flow-col mt-2 gap-4">
        ...
        <div class="w-auto md:col-span-4">
            <div class="w-auto bg-wite shadow-md rounded-lg">
                <table class="w-full text-left w-full">
                    <thead>
                    <tr>
                    ...
                    @foreach ($kelass as $kelas)
                     <tr class="hover:bg-slate-50 border-b border-slate-200">
                         ...
                         <p class="flex mx-auto">
                             <a href="/kelas/edit/{{$kelas->id}}" class="cursor-pointer bg-blue-500 hover:bg-blue-700 p-3 rounded-lg group">
                             ...
                             <a onclick="return confirm('Apakah anda yakin untuk menghapus kelas {{ $kelas->nama_kelas }}?')" href="/kelas/hapus/{{ $kelas->id }}" class="cursor-pointer bg-red-500 hover:bg-red-700 p-3 rounded-lg group ml-2">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
